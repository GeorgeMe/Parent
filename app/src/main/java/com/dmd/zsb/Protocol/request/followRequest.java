 ...
 */
public class followRequest extends SugarRecord implements Serializable {
    ...
    public followRequest(String appkey, String version, String sid, String uid, String page, String rows, String user_id) {
        super();
        this.appkey = appkey;
