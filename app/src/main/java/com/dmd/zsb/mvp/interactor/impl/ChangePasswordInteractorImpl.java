...
public class ChangePasswordInteractorImpl implements CommonSingleInteractor {
    ...
    public void getCommonSingleData(JSONObject json) {
        GsonRequest<JSONObject> gsonRequest=new GsonRequest<JSONObject>(UriHelper.getInstance().changePassword(json),null,new TypeToken<JSONObject>(){}.getType(), new Response.Listener<JSONObject>(){
            @Override
