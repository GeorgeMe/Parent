 ...
 */
public class UserDetailInteractoterImpl implements CommonListInteractor {
    private BaseMultiLoadedListener<userdetailsResponse> loadedListener = null;

    public UserDetailInteractoterImpl(BaseMultiLoadedListener<userdetailsResponse> loadedListener) {
        this.loadedListener = loadedListener;
    }

    @Override
    public void getCommonListData(final int event, JSONObject json) {
        GsonRequest<userdetailsResponse> gsonRequest = new GsonRequest<userdetailsResponse>(
                UriHelper.getInstance().userDetail(json),
                null,
                new TypeToken<userdetailsResponse>() {
                }.getType(),
                new Response.Listener<userdetailsResponse>() {
                    @Override
                    public void onResponse(userdetailsResponse response) {
