...
public class ImageUtil {
    ...
    public static String zoomImage(String path, int maxSize) {
        try {
            ...
            if (max > maxSize) {
                ...
                String fileName;
                if (path.startsWith(Constants.FILEPATH))
                {
                	fileName = path;
				}
                else
                {
					fileName = Constants.FILEPATH +"img/"+ Constants.imageName();
				}
    ...
    public static Bitmap createVideoThumbnail(String filePath) {
        ...
        fileDir = new File(Constants.FILEPATH + "img/");
        if (!fileDir.exists()) {
            fileDir.mkdirs();
        }


        String fileName = Constants.FILEPATH+ "img/"+ Constants.imageName();
        try
        {
